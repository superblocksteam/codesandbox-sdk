...
import type {
  ...
  TokenCreateData,
  TokenCreateError,
  TokenCreateResponse2,
  TokenUpdateData,
  TokenUpdateError,
  TokenUpdateResponse2,
  SandboxListData,
  SandboxListError,
  SandboxListResponse2,
  SandboxCreateData,
  SandboxCreateError,
  SandboxCreateResponse2,
  SandboxGetData,
  SandboxGetError,
  SandboxGetResponse2,
  SandboxForkData,
  SandboxForkError,
  SandboxForkResponse2,
  VmHibernateData,
  VmHibernateError,
  VmHibernateResponse,
  VmShutdownData,
 ...
 */
export const metaInfo = <ThrowOnError extends boolean = false>(
 ...
 *
 */
export const workspaceCreate = <ThrowOnError extends boolean = false>(
  options?: OptionsLegacyParser<WorkspaceCreateData, ThrowOnError>
) => {
...
export const tokenCreate = <ThrowOnError extends boolean = false>(
  options?: OptionsLegacyParser<TokenCreateData, ThrowOnError>
) => {
  return (options?.client ?? client).post<
    TokenCreateResponse2,
    TokenCreateError,
 ...
 *
 */
export const tokenUpdate = <ThrowOnError extends boolean = false>(
  options?: OptionsLegacyParser<TokenUpdateData, ThrowOnError>
) => {
 ...
 *
 */
export const sandboxList = <ThrowOnError extends boolean = false>(
  options?: OptionsLegacyParser<SandboxListData, ThrowOnError>
) => {
  return (options?.client ?? client).get<
    SandboxListResponse2,
    SandboxListError,
 ...
 *
 */
export const sandboxCreate = <ThrowOnError extends boolean = false>(
  options?: OptionsLegacyParser<SandboxCreateData, ThrowOnError>
) => {
  return (options?.client ?? client).post<
    SandboxCreateResponse2,
    SandboxCreateError,
...
export const sandboxGet = <ThrowOnError extends boolean = false>(
  options: OptionsLegacyParser<SandboxGetData, ThrowOnError>
) => {
  return (options?.client ?? client).get<
    SandboxGetResponse2,
    SandboxGetError,
 ...
 *
 */
export const sandboxFork = <ThrowOnError extends boolean = false>(
  options: OptionsLegacyParser<SandboxForkData, ThrowOnError>
) => {
  return (options?.client ?? client).post<
    SandboxForkResponse2,
    SandboxForkError,
 ...
 *
 */
export const vmHibernate = <ThrowOnError extends boolean = false>(
  options: OptionsLegacyParser<VmHibernateData, ThrowOnError>
) => {
  return (options?.client ?? client).post<
    VmHibernateResponse,
    VmHibernateError,
...
export const vmShutdown = <ThrowOnError extends boolean = false>(
  options: OptionsLegacyParser<VmShutdownData, ThrowOnError>
) => {
  return (options?.client ?? client).post<
    VmShutdownResponse,
    VmShutdownError,
...
export const vmStart = <ThrowOnError extends boolean = false>(
  options: OptionsLegacyParser<VmStartData, ThrowOnError>
) => {
  return (options?.client ?? client).post<
    VmStartResponse,
    VmStartError,
 ...
 *
 */
export const vmUpdateSpecs = <ThrowOnError extends boolean = false>(
  options: OptionsLegacyParser<VmUpdateSpecsData, ThrowOnError>
) => {
  return (options?.client ?? client).post<
    VmUpdateSpecsResponse,
    VmUpdateSpecsError,
